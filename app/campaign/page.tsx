      ...
      <div className="px-4 pt-4 space-y-4">
        {allCampaigns.length === 0 ? (
          ...
          allCampaigns.map((campaign) => (
            <Link key={campaign.id} href={`/campaign/${campaign.id}`} prefetch={false} className="block bg-white rounded-2xl shadow-sm border border-pink-50 overflow-hidden hover:shadow-md transition-shadow group">
