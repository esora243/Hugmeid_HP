    ...
    <div className="w-full max-w-lg mx-auto bg-[#FFF9FA] min-h-screen animate-slide-in-bottom pb-20">
      <div className="bg-white px-6 py-8 border-b border-pink-100 shadow-sm relative">
        <div className="flex flex-col items-center">
          ...
          <p className="text-xs text-gray-500 mt-1 font-medium bg-pink-50 px-3 py-1 rounded-full border border-pink-100">ID: {me?.lineUidMasked}</p>
      ...
      <div className="p-4 space-y-4 -mt-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-pink-50 overflow-hidden divide-y divide-gray-50">
          <button onClick={() => toast.info("通知設定は現在準備中です")} className="w-full flex items-center justify-between p-4 hover:bg-pink-50/50 transition-colors group">
          ...
          <button onClick={() => router.push("/connect")} className="w-full flex items-center justify-between p-4 hover:bg-pink-50/50 transition-colors group">
