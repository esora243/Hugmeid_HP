    ...
    <div className="w-full max-w-lg mx-auto pb-8 animate-slide-in-right">
      ...
      <div className="px-4 pt-3 space-y-4">
        ...
        {activeTab === "groups" && studentGroups.map((group) => (
          <Link key={group.id} href={`/activities/groups/${group.id}`} prefetch={false} className="block bg-white rounded-2xl shadow-sm border border-orange-50 overflow-hidden hover:shadow-md transition-shadow group">
            ...
            <div key={program.id} className="block bg-white rounded-2xl shadow-sm border border-orange-50 overflow-hidden hover:shadow-md transition-shadow group">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-50">
                  ...
                  {programUrl ? (
                    <a href={programUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 text-xs font-bold text-orange-500 hover:text-orange-600">詳細 <ExternalLink size={12} /></a>
        ...
        {activeTab === "articles" && activityArticles.map((article) => {
          ...
          return (
            <a key={article.id} href={articleUrl || "#"} target={articleUrl ? "_blank" : undefined} rel={articleUrl ? "noopener noreferrer" : undefined} className="block bg-white rounded-2xl shadow-sm border border-orange-50 overflow-hidden hover:shadow-md transition-shadow group">
